...
async function login(){
 ...
 const options={
  ...
  const url ="http://ec2-3-82-60-217.compute-1.amazonaws.com:8080/api/signin/agent"
  try{
...
{errors.user && <p className="text-error">UserName Required</p>}
        ...
        <span className="form-input-login">
          Dont't Hava an account? Register <a href="/form">here</a>
        </span>
      </div>
